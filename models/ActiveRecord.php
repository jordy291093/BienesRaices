...
class ActiveRecord {
    ...
    // Busqueda Where con Columna multiples opciones
    public static function whereArray($array = []) {
        $query = "SELECT * FROM " . static::$tabla . " WHERE ";
        foreach($array as $key => $value) {
            // ver el ulltimo elemento si agregar una condicion o no
    ...
    // Busca los registros de ventas 
    public static function whereAND($columna, $valor, $columna2, $valor2) {
